...
X_train, X_test, Y_train, Y_test = np.load(
    './crawling/movie_data_max_2000_wordsize_47335.npy',
    allow_pickle=True)
print(X_train.shape, Y_train.shape)
print(X_test.shape, Y_test.shape)

model = Sequential()
model.add(Embedding(47335, 300, input_length=2000))
...
model.save('./models/movie_category_classfication_model_2000{}.h5'.format(
